...
public class Main {
    ...
    public static Semaphore clients_sem = new Semaphore(0);
    public static Semaphore barber_ready_sem = new Semaphore(0);
    public static Semaphore chairs_sem = new Semaphore(1);
    // TODO: add semaphores
